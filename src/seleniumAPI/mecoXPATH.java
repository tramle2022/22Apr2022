...
public class mecoXPATH {
	...
	//	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		...
		//hover menu
		//WebElement	ele = driver.findElement(By.xpath("//body/div[@id='page']/header[@id='masthead']/div[contains(@class,'site-branding')]/div[contains(@class,'yc-header-builder-content header-fixed')]/section[@id='desktop-section']/div[@id='mecox-desktop-menu']/div[contains(@class,'wpb_column vc_column_container vc_col-sm-5')]/div[contains(@class,'vc_column-inner')]/div[contains(@class,'wpb_wrapper')]/div[contains(@class,'mega-items-column-equal')]/div[@class='horizontal']/ul[@id='menu-header-menu-left']/li[@id='menu-item-191397']/a[@class='item-has-icon icon-position-left']/span[1]"));
